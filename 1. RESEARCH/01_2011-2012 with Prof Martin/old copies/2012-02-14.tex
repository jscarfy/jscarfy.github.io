...
\] 
\end{rmk}\section{Classical Results by Knapowski and Tur\'an, Series I}\label{sec.Results1}
...
Finally we have some unconditional results at the end of series 1, for $k=8$
...
\section{Classical Results by Knapowski and Tur\'an, Series II}\label{sec.Results2}
...
The most recent developments on the race-problem of Shanks-R\`enyi are due to Y. Lamzouri in his two papers~\cite{201x.Lamzouri_1}~\cite{201x.Lamzouri_2}, where he defines:  
...
\end{thm}
giving a conditional bound of the tails to the measure $\mu_{q; a_1, \hdots, a_r}$, fully generalizing the work done by Montgomery~\cite{1980.Montgomery} on $\mu_{1; 1}$.
%%%%%%%%%%%%%%%%%
\section{References}
\begin{biblist}
...
%%%---------------------------------------------------------------------------------------
\bib{1962.Knapowski_(pi-li)_1}{article}{
    author={Knaposwki, S.},
...
\bib{1977.Bays}{article}{
 AUTHOR = {Bays, Carter and Hudson, Richard H.},
     TITLE = {The segmented sieve of {E}ratosthenes and primes in arithmetic
